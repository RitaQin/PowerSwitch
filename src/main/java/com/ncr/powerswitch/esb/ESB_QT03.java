...
public class ESB_QT03 {

	private final static Log log = LogFactory.getLog(ESB_QT03.class);
	...
	public String constructRequest(Map<String, Object> requestValues) {
		...
		String templateFileName = "qt03.xml";
		String requestXml = "";
		...
		try {
			...
			context.put("terminalCode",
					requestValues.get("terminalCode") == null ? EMPTY_STRING : requestValues.get("terminalCode"));
			// APP_HEAD
			...
			context.put("quryTp", requestValues.get("quryTp") == null ? EMPTY_STRING : requestValues.get("quryTp"));

			requestXml = FreeMarkerTemplateUtils.processTemplateIntoString(template, context);
			log.info("QT03 Request :  " + requestXml);
