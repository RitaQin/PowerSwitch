...
//			String test = requestValues.get("channelId").toString();
			...
			//Head			
			context.put("consumerSeqNo", requestValues.get("consumerSeqNo") == null ? "" : requestValues.get("consumerSeqNo"));
			context.put("tranDate", requestValues.get("tranDate") == null ? "" : requestValues.get("tranDate"));
			
			//APP Head
			context.put("tranTellerNo", requestValues.get("tranTellerNo") == null ? "" : requestValues.get("tranTellerNo"));
			...
			context.put("formrTranDate", requestValues.get("formrTranDate")==null ? "" : requestValues.get("formrTranDate"));
			context.put("formrSeqNo", requestValues.get("formrSeqNo")==null ? "" : requestValues.get("formrSeqNo"));
			
			context.put("agntIdentTp", requestValues.get("agntIdentTp") == null ? "" : requestValues.get("agntIdentTp"));
			context.put("agntIdentNo", requestValues.get("agntIdentNo")==null ? "" : requestValues.get("agntIdentNo"));
			...
			context.put("formrTxnTlrNo", requestValues.get("formrTxnTlrNo")==null ? "" : requestValues.get("formrTxnTlrNo"));
			
			context.put("formrAhrTlrNo", requestValues.get("formrAhrTlrNo")==null ? "" : requestValues.get("formrAhrTlrNo"));
